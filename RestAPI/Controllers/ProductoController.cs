...
namespace RestAPI.Controllers
{
    ...
    public class ProductoController : ControllerBase
    {
        ...
        public ProductoController(IProductoRepository productoRepository, IMapper mapper, ILogger<IProductoRepository> logger)
        ...
        public async Task<IActionResult> GetAll()
        {
            try
            {
                ...
                var entities = _mapper.Map<List<ProductoDto>>(await _productoRepository.GetAllAsync());
                return Ok(entities);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetByName(string name)
        {
            try
            {
                ...
                var productsDto = _mapper.Map<List<ProductoDto>>(entities);
        ...
        public async Task<IActionResult> Create([FromBody] CreateProductoDto createDto)
        {
            try
            {
                ...
                var entity = _mapper.Map<ProductoEntity>(new CreateProductoDto
                {
